...
\newglossaryentry{fifo}{name={FIFO-Queue},description={First In First Out Queue. Bezeichnung für eine Warteschlange, bei der zuerst Eintretende auch als erstes wieder herauskommt. Im Gegensatz zu LIFO (Last In First Out), wo jeweils der jüngste Eintrag zuerst ausgelesen wird.}}