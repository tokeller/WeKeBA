...
\todo{Zeitplan}
\todo{Besprechungsprotokolle oder Journals}
...
\includepdf[pages={7}]{images/datasheets/LPC408X_7X.pdf}
...
\todo{Berechnungen, Messwerte, Simulationsresultate}
\todo{Grafische Darstellungen, Fotos}
...
\todo{CD mit dem vollständigen Bericht als pdf-File inklusive Film- und Fotomaterial}
