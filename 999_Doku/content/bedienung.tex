...
Die Speicherkarte kann über einen wasserdichten Schraubdeckel ausgewechselt werden, ohne dass das ganze Gehäuse des \gls{logger}s geöffnet werden muss. Der Umgang mit der Speicherkarte ist in den Abschnitt \ref{sssec.sdformat} bis \ref{sssec.sdunmount} ab Seite \pageref{sssec.sdformat} erklärt.
...
\todo{Föteli/Schema Abschlusswiderstand}
...
Die Steckverbinder sind fünfpolig und wasserdicht (IP68). Die Pole sind gemäss Tabelle \ref{table.stecker} bestückt. Auf der Leiterplatte der \gls{sensoreinh} ist eine Schraubklemmenleiste mit 8 Anschlüssen angebracht. Jeweils zwei benachbarte Anschlüsse sind zusammengeschaltet, damit jede Leitung einzeln fest verschraubt werden kann. Es wird nicht empfohlen, zwei gleiche Leitungen in einer einzelnen Schraubklemme zusammen zu verschrauben.

\begin{table}
\begin{tabular}{|l|l|l|}
\hline \textbf{Pol Nr.}      & \textbf{Leitung} & Anschluss Schraubklemme\\ 
\hline 1 & Spannungsversorgung +12~V & +12V\\
\hline 2 & Spannungsversorgung 0~V & GND\\
\hline 3 & unbenutzt & \\
\hline 4 & CAN-Bus High & CANH \\
\hline 5 & CAN-Bus Low & CANL \\
\hline 
\end{tabular}
